...
function playRound() {
    ...
    if (playerHand == 'rock' && computerHand == 'Scissors' || playerHand == 'paper' && computerHand == 'Rock' ||
            playerHand == 'scissors' && computerHand == 'Paper') {
        win = true;
    } else if (playerHand == 'rock' && computerHand == 'Paper' || playerHand == 'paper' && computerHand == 'Scissors' ||
...
//     }
//     if (playerScore == 5) {
//         console.log('You have won 5 rounds. You win the game!')
//     } else if (computerScore == 5) {
//         console.log('The computer has won 5 rounds. You are a loser!')
//     }
//     playerHand = null;
//     computerHand = null;
//     win = false;
